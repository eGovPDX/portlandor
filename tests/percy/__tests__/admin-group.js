...
describe('SuperAdmin user test', () => {
  ...
  it('superAdmin manages group', async function () {
    try {
      let text_content = '',
        selector = '';
      ...
      await page.type(
        ...
        'Official name of Percy test group',
      );
      await page.type(
        '#edit-field-summary-0-value',
        'This is a test summary for the Percy Test group',
      );
      ...
      text_content = await page.evaluate(
        () => document.querySelector('table.views-view-table').textContent,
      );
