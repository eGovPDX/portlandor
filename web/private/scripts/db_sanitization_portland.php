...
if (defined('PANTHEON_ENVIRONMENT') && (PANTHEON_ENVIRONMENT !== 'live')) {
	...
	$sanitize_query = "update users_field_data inner join user__roles on uid = entity_id set pass = '', mail = concat('user+', uid, '@localhost.localdomain'), init = concat('user+', uid, '@localhost.localdomain') where roles_target_id <> 'administrator';";
