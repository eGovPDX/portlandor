...
if (defined('PANTHEON_ENVIRONMENT') && (PANTHEON_ENVIRONMENT !== 'live')) {
	...
	$revisions_query = "DROP TEMPORARY TABLE IF EXISTS candidate_nodes;
CREATE TEMPORARY TABLE candidate_nodes
SELECT n.nid, n.changed, r.vid, COUNT(*) AS total
FROM
node_field_data n
...
DROP TEMPORARY TABLE IF EXISTS candidate_nodes;
DROP TEMPORARY TABLE IF EXISTS expired_revisions;";
