...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__c",
      "vtp_value":"portland.gov, activecommunities.com"
    },{
      "function":"__v",
      ...
      "vtp_setDefaultValue":true,
      "vtp_input":["macro",6],
      "vtp_defaultValue":"UA-6858269-13",
      "vtp_map":["list",["map","key","Live","value","UA-6858269-14"],["map","key","Preproduction","value","UA-6858269-13"]]
    },{
      "function":"__gas",
      ...
      "vtp_dimension":["list",["map","index","1","dimension",["macro",4]],["map","index","2","dimension",["macro",5]]],
      ...
      "vtp_attribute":"data-file-ext"
    },{
      "function":"__aev",
      "vtp_varType":"TEXT"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",18],8,16],";return a.replace(\/^Download (\\w+ )?file \/,\"\")})();"]
    },{
      "function":"__u",
      "vtp_component":"PATH",
      "vtp_enableMultiQueryKeys":false,
      ...
      "vtp_affiliatedDomains":"portland.gov,lndo.site,portlandor.pantheonsite.io"
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",14],8,16],";return a.split(\"mailto:\")[1]})();"]
    },{
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",14],8,16],";return a.split(\"tel:\")[1]})();"]
    },{
      "function":"__v",
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){for(var a=0;a\u003CdataLayer[0].transactionProducts.length;a++)null!==dataLayer[0].transactionProducts[a].name.match(\/^(.*?(^(Swim|Aquatics|Swimming)[^$]*)$\/gi)\u0026\u0026alert(\"TRUE \"+JSON.stringify(dataLayer[0].transactionProducts[a].name,null,4));return!1})();"]
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var b=",["escape",["macro",31],8,16],",c;var a=0;for(c=b.length;a\u003Cc;a++)b[a].name.match(\/membership\/gi),b[a].name.match(\/membership\/gi);return!1})();"]
    },{
      "function":"__u",
      "vtp_component":"HOST",
      "vtp_enableMultiQueryKeys":false,
  ...
  "tags":[{
      ...
      "once_per_event":true,
      "vtp_overrideGaSettings":true,
      "vtp_fieldsToSet":["list",["map","fieldName","page","value","newcart\/checkout"],["map","fieldName","title","value","Checkout"]],
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_gaSettings":["macro",8],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableTransportUrl":true,
      ...
      "once_per_event":true,
      "vtp_overrideGaSettings":true,
      "vtp_fieldsToSet":["list",["map","fieldName","page","value","\/newcart\/checkout\/confirmation"],["map","fieldName","title","value","Confirmation"]],
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_gaSettings":["macro",8],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableTransportUrl":true,
      ...
      "vtp_gaSettings":["macro",8],
      "vtp_eventAction":["template",["macro",16],["macro",17]],
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":true,
      "vtp_eventCategory":"Phone numbers",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",8],
      "vtp_eventAction":"Click",
      ...
      "vtp_eventLabel":["template",["macro",25]," (Line ",["macro",26],")"],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableTransportUrl":true,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "once_per_event":true,
      "vtp_overrideGaSettings":true,
      "vtp_fieldsToSet":["list",["map","fieldName","page","value",["macro",27]],["map","fieldName","title","value",["macro",19]]],
      "vtp_trackType":"TRACK_PAGEVIEW",
      "vtp_gaSettings":["macro",8],
      "vtp_enableRecaptchaOption":false,
      "vtp_enableTransportUrl":true,
      ...
      "vtp_uniqueTriggerId":"31805216_26",
      "tag_id":52
    },{
      "function":"__lcl",
      "vtp_waitForTags":true,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"31805216_30",
      "tag_id":53
    },{
      "function":"__lcl",
      "vtp_waitForTags":true,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"31805216_31",
      "tag_id":54
    },{
      "function":"__lcl",
      "vtp_waitForTags":true,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"31805216_36",
      "tag_id":55
    },{
      "function":"__hl",
      "tag_id":56
      ...
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"31805216_47",
      "tag_id":58
    }],
  "predicates":[{
      "function":"_eq",
      ...
      "function":"_re",
      "arg0":["macro",9],
      "arg1":"ActiveNet_Order_Confirmation"
    },{
      "function":"_eq",
      "arg0":["macro",12],
      "arg1":"payOrder"
      ...
      "function":"_cn",
      "arg0":["macro",9],
      "arg1":"onlineSiteId=0\u0026from_original_cui=true"
    },{
      "function":"_cn",
      "arg0":["macro",13],
      "arg1":"btn-strong"
  ...
  "rules":[
    ...
    [["if",5,6,8],["unless",7],["add",1]],
    [["if",0,9],["add",2]],
    [["if",10,11],["add",2,4]],
    [["if",12,13,14],["add",3]],
    [["if",15,16,17],["add",5]],
    [["if",16,18,19],["add",5,10]],
    [["if",16,20,21,22],["add",6]],
    [["if",16,23,24],["add",7]],
    [["if",16,25,26],["add",8]],
    [["if",27],["add",9]],
    [["if",0,28],["add",12,13,14,15,18]]]
},
"runtime":[]
...
var Ld=[C.B,C.J],Md=function(a){var b=a[C.Qd];b&&D(40);var c=a[C.Rd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Qd&&f!==C.Rd)if(-1<Ga(Ld,f)){var h=f,k=a[f],l=d[e];wd().set(h,k,l,"US","US-OR",c)}else{}},Nd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
var Ph=function(){var a=!1;return a},Rh=function(a){var b=af("gtm.allowlist")||af("gtm.whitelist");b&&D(9);Ph()&&(b="google gtagfl lcl zone oid op".split(" "));var c=b&&fb(Ua(b),Mh),d=af("gtm.blocklist")||
...
a.Ye&&y("did",a.Ye);var M=A+"/pagead/landing?"+z.join("&");rd(M)}}var c=!!a.od,d=!!a.ma,e=a.R,f=void 0===a.sc?{}:a.sc,h=void 0===a.zc?!0:a.zc,k=Og(),l=k.gclid||"",n=k.gclsrc,q=k.dclid||"",p=k.gbraid||"",r=!c&&((!l||n&&"aw.ds"!==n?!1:!0)||p),u=Fd();if(r||u)u?Qd(function(){b();Od(C.B)||Jd(function(t){return b(!0,t.Ve)},C.B)},[C.B]):b()}function sk(a,b){var c=a&&!Od(C.B);return b&&c?"0":b}var cl=function(){var a=!0;ok(7)&&ok(9)&&ok(10)||(a=!1);var b=!0;b=!1;b&&!bl()&&(a=!1);return a},bl=function(){var a=!0;ok(3)&&ok(4)||(a=!1);return a};var yl=!1;function zl(){var a=L;return a.gcq=a.gcq||new Al}
...
function Lm(){for(var a=!1;!Gm&&0<Dm.length;){var b=!1;if(b&&!Fm&&Km()){var c={};Dm.unshift((c.event=
"gtm.init",c));Fm=!0}var d=!1;if(d&&!Em&&Km()){var e={};Dm.unshift((e.event="gtm.init_consent",e));Em=!0}Gm=!0;delete Ye.eventModel;$e();var f=Dm.shift();if(null!=f){var h=Bm(f);
...
Z.g.jsm=["customScripts"],function(){(function(a){Z.__jsm=a;Z.__jsm.h="jsm";Z.__jsm.i=!0;Z.__jsm.priorityOverride=0})(function(a){if(void 0!==a.vtp_javascript){var b=a.vtp_javascript;try{var c=W("google_tag_manager");var d=c&&c.e&&c.e(b);wn(d,"jsm",a.vtp_gtmEventId);return d}catch(e){}}})}();
Z.g.c=["google"],function(){(function(a){Z.__c=a;Z.__c.h="c";Z.__c.i=!0;Z.__c.priorityOverride=0})(function(a){wn(a.vtp_value,"c",a.vtp_gtmEventId);return a.vtp_value})}();
...
Z.g.f=["google"],function(){(function(a){Z.__f=a;Z.__f.h="f";Z.__f.i=!0;Z.__f.priorityOverride=0})(function(a){var b=nn("gtm.referrer",1)||I.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?je(le(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):mn(String(b)):String(b)})}();
Z.g.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=Ll(c,"gtm.click");on(d)}}(function(b){Z.__cl=b;Z.__cl.h="cl";Z.__cl.i=!0;Z.__cl.priorityOverride=0})(function(b){if(!tn("cl")){var c=W("document");ld(c,"click",a,!0);un("cl")}J(b.vtp_gtmOnSuccess)})}();

Z.g.u=["google"],function(){var a=function(b){return{toString:function(){return b}}};(function(b){Z.__u=b;Z.__u.h="u";Z.__u.i=!0;Z.__u.priorityOverride=0})(function(b){var c;c=(c=b.vtp_customUrlSource?b.vtp_customUrlSource:nn("gtm.url",1))||kn();var d=b[a("vtp_component")];if(!d||"URL"==d)return mn(String(c));var e=le(String(c)),f;if("QUERY"===d)a:{var h=b[a("vtp_multiQueryKeys").toString()],k=b[a("vtp_queryKey").toString()]||"",l=b[a("vtp_ignoreEmptyQueryParam").toString()],n;h?Fa(k)?n=k:n=String(k).replace(/\s+/g,
...
Z.g.ua=["google"],function(){function a(p){return Od(p)}function b(p,r){var u=!1;if(Fd()&&!u&&!e[p]){var t=function(){var v=si(),x="gtm"+Ve(),z=n(r),w={name:x};l(z,w,!0);v("create",p,w);v(function(){v.remove(x)})};Jd(t,C.J);Jd(t,C.B);e[p]=!0}}var c,d={},e={},f={name:!0,clientId:!0,sampleRate:!0,siteSpeedSampleRate:!0,alwaysSendReferrer:!0,allowAnchor:!0,
...
l=function(p,r,u){var t=0;if(p)for(var v in p)if(!k[v]&&p.hasOwnProperty(v)&&(u&&f[v]||!u&&void 0===f[v])){var x=h[v]?Qa(p[v]):p[v];"anonymizeIp"!=v||x||(x=void 0);r[v]=x;t++}return t},n=function(p){var r={};p.vtp_gaSettings&&m(co(p.vtp_gaSettings.vtp_fieldsToSet,"fieldName","value"),r);m(co(p.vtp_fieldsToSet,"fieldName","value"),r);Od(C.J)||(r.storage="none");Od(C.B)||(r.allowAdFeatures=!1,r.storeGac=!1);cl()||(r.allowAdFeatures=!1);bl()||(r.allowAdPersonalizationSignals=!1);p.vtp_transportUrl&&
(r._x_19=p.vtp_transportUrl);if(Qa(r.urlPassthrough)){r._useUp=!0;var u=!1;Fd()&&!u&&(r._cs=a)}return r},
q=function(p){function r(fa,V){void 0!==V&&E("set",fa,V)}var u={},t={},v={},x={};if(p.vtp_gaSettings){var z=p.vtp_gaSettings;m(co(z.vtp_contentGroup,"index","group"),t);m(co(z.vtp_dimension,"index","dimension"),v);m(co(z.vtp_metric,"index","metric"),x);var w=m(z);w.vtp_fieldsToSet=void 0;w.vtp_contentGroup=void 0;w.vtp_dimension=void 0;w.vtp_metric=void 0;p=m(p,w)}m(co(p.vtp_contentGroup,"index","group"),t);m(co(p.vtp_dimension,"index","dimension"),v);m(co(p.vtp_metric,"index","metric"),x);var y=
n(p),A=ui(p.vtp_functionName);if(Ca(A)){var B="",F="";p.vtp_setTrackerName&&"string"==typeof p.vtp_trackerName?""!==p.vtp_trackerName&&(F=p.vtp_trackerName,B=F+"."):(F="gtm"+Ve(),B=F+".");var E=function(fa){var V=[].slice.call(arguments,0);V[0]=B+V[0];A.apply(window,V)},H=function(fa,V){return void 0===V?V:fa(V)},M=function(fa,V){if(V)for(var ob in V)V.hasOwnProperty(ob)&&E("set",fa+ob,V[ob])},N=function(){},R={name:F};l(y,R,!0);var ha=p.vtp_trackingId||u.trackingId;A("create",ha,R);E("set","&gtm",Ij(!0));var S=!1;
Fd()&&!S&&(E("set","&gcs",Pd()),b(ha,p));y._x_19&&(null==ed&&delete y._x_19,y._x_20&&!d[F]&&(d[F]=!0,A(zi(F,String(y._x_20)))));p.vtp_enableRecaptcha&&E("require","recaptcha","recaptcha.js");(function(fa,V){void 0!==p[V]&&E("set",fa,p[V])})("nonInteraction","vtp_nonInteraction");M("contentGroup",t);M("dimension",v);M("metric",x);var K={};l(y,K,!1)&&E("set",K);var T;
...
p.vtp_trackType){E("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var xa=function(fa){return nn("transaction"+fa,1)},na=xa("Id");E("ecommerce:addTransaction",{id:na,affiliation:xa("Affiliation"),revenue:xa("Total"),shipping:xa("Shipping"),tax:xa("Tax")});for(var Y=xa("Products")||[],Da=0;Da<Y.length;Da++){var mb=Y[Da];E("ecommerce:addItem",{id:na,sku:mb.sku,name:mb.name,category:mb.category,price:mb.price,
quantity:mb.quantity})}E("ecommerce:send");}else if("TRACK_TIMING"==p.vtp_trackType){}else if("DECORATE_LINK"==
p.vtp_trackType){}else if("DECORATE_FORM"==p.vtp_trackType){
A(function(){var fa=si(),V=nn("gtm.element",1),ob=fa&&fa.getByName&&fa.getByName(F),Mb=Jc(W("gaplugins").Linker,ob);if(V&&V.method&&"post"!=V.method.toLowerCase()){for(var Nb=V.childNodes,pb=0;pb<Nb.length;pb++)if("google_tag_manager_ua_cookie"==Nb[pb].className){V.removeChild(Nb[pb]);break}var Pa=Mb.decorate(V.action)||V.action;Pa=Pa.split("?")[1].split("&");for(var Q=0;Q<Pa.length;Q++){var gb=document.createElement("input");gb.type="hidden";gb.className="google_tag_manager_ua_cookie";var Ra=Pa[Q].indexOf("=");
0<Ra&&(gb.name=Pa[Q].slice(0,Ra),gb.value=Pa[Q].slice(Ra+1),V.insertBefore(gb,null))}}else V&&V.action&&(V.action=Mb.decorate(V.action,p.vtp_useHashDecorateForm)||V.action,J(p.vtp_gtmOnSuccess))});}else if("TRACK_DATA"==p.vtp_trackType){}else{p.vtp_enableEcommerce&&
(E("require","ec","ec.js"),N());if(p.vtp_doubleClick||"DISPLAY_FEATURES"==p.vtp_advertisingFeaturesType){var Ja="_dc_gtm_"+String(p.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");E("require","displayfeatures",void 0,{cookieName:Ja})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==p.vtp_advertisingFeaturesType){var Xa="_dc_gtm_"+String(p.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");E("require","adfeatures",{cookieName:Xa})}T?E("send","pageview",T):E("send","pageview");
p.vtp_autoLinkDomains&&vi(B,p.vtp_autoLinkDomains,!!p.vtp_useHashAutoLink,!!p.vtp_decorateFormsAutoLink);Qa(y.urlPassthrough)&&wi(B)}if(!c){var eb=p.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js";p.vtp_useInternalVersion&&!p.vtp_useDebugVersion&&(eb="internal/"+eb);c=!0;var xb=sj(y._x_19,"/analytics.js"),Ya=uh("https:","http:","//www.google-analytics.com/"+eb,y&&!!y.forceSSL);O("analytics.js"===eb&&xb?xb:Ya,function(){var fa=
si();fa&&fa.loaded||p.vtp_gtmOnFailure();},p.vtp_gtmOnFailure)}}else J(p.vtp_gtmOnFailure)};(function(p){Z.__ua=p;Z.__ua.h="ua";Z.__ua.i=!0;Z.__ua.priorityOverride=0})(function(p){Qd(function(){q(p)},
[C.J,C.B])})}();
Z.g.jel=["google"],function(){(function(a){Z.__jel=a;Z.__jel.h="jel";Z.__jel.i=!0;Z.__jel.priorityOverride=0})(function(a){if(!tn("jel")){var b=W("self"),c=b.onerror;b.onerror=function(d,e,f,h,k){c&&c(d,e,f,h,k);on({event:"gtm.pageError","gtm.errorMessage":d,"gtm.errorUrl":e,"gtm.errorLineNumber":f});return!1};un("jel")}J(a.vtp_gtmOnSuccess)})}();
...
Z.g.aev=["google"],function(){function a(u,t,v){var x=u||gf(t,"gtm");if(x)return x[v]}function b(u,t,v,x,z){z||(z="element");var w=t+"."+v,y;if(q.hasOwnProperty(w))y=q[w];else{var A=a(u,t,z);if(A&&(y=x(A),q[w]=y,p.push(w),35<p.length)){var B=p.shift();delete q[B]}}return y}function c(u,t,v,x){var z=a(u,t,r[v]);return void 0!==z?z:x}function d(u,t){if(!u)return!1;var v=e(kn());Fa(t)||(t=String(t||"").replace(/\s+/g,"").split(","));for(var x=[v],z=0;z<t.length;z++){var w=t[z];if(w.hasOwnProperty("is_regex"))if(w.is_regex)try{w=
new RegExp(w.domain)}catch(A){continue}else w=w.domain;if(w instanceof RegExp){if(w.test(u))return!1}else{var y=w;if(0!=y.length){if(0<=e(u).indexOf(y))return!1;x.push(e(y))}}}return!bo(u,x)}function e(u){n.test(u)||(u="http://"+u);return je(le(u),"HOST",!0)}function f(u,t,v,x){switch(u){case "SUBMIT_TEXT":return b(t,v,"FORM."+u,h,"formSubmitElement")||x;case "LENGTH":var z=b(t,v,"FORM."+u,k);return void 0===z?x:z;case "INTERACTED_FIELD_ID":return l(t,v,"id",x);case "INTERACTED_FIELD_NAME":return l(t,
v,"name",x);case "INTERACTED_FIELD_TYPE":return l(t,v,"type",x);case "INTERACTED_FIELD_POSITION":var w=a(t,v,"interactedFormFieldPosition");return void 0===w?x:w;case "INTERACT_SEQUENCE_NUMBER":var y=a(t,v,"interactSequenceNumber");return void 0===y?x:y;default:return x}}function h(u){switch(u.tagName.toLowerCase()){case "input":return nd(u,"value");case "button":return od(u);default:return null}}function k(u){if("form"===u.tagName.toLowerCase()&&u.elements){for(var t=0,v=0;v<u.elements.length;v++)Um(u.elements[v])&&
...
0})(function(u){var t=u.vtp_gtmEventId,v=u.vtp_defaultValue,x=u.vtp_varType,z;switch(x){case "TAG_NAME":var w=a(z,t,"element");return w&&w.tagName||v;case "TEXT":return b(z,t,x,od)||v;case "URL":var y;a:{var A=String(a(z,t,"elementUrl")||v||""),B=le(A),F=String(u.vtp_component||"URL");switch(F){case "URL":y=A;break a;case "IS_OUTBOUND":y=
d(A,u.vtp_affiliatedDomains);break a;default:y=je(B,F,u.vtp_stripWww,u.vtp_defaultPages,u.vtp_queryKey)}}return y;case "ATTRIBUTE":var E;if(void 0===u.vtp_attribute)E=c(z,t,x,v);else{var H=u.vtp_attribute,M=a(z,t,"element");E=M&&nd(M,H)||v||""}return E;case "MD":var N=u.vtp_mdValue,R=b(z,t,"MD",cn);return N&&R?fn(R,N)||v:R||v;case "FORM":return f(String(u.vtp_component||"SUBMIT_TEXT"),z,t,v);default:var ha=c(z,t,x,v);wn(ha,"aev",u.vtp_gtmEventId);return ha}})}();

Z.g.gas=["google"],function(){(function(a){Z.__gas=a;Z.__gas.h="gas";Z.__gas.i=!0;Z.__gas.priorityOverride=0})(function(a){var b=m(a),c=b;c[sb.Oa]=null;c[sb.pg]=null;var d=b=c;d.vtp_fieldsToSet=d.vtp_fieldsToSet||[];var e=d.vtp_cookieDomain;void 0!==e&&(d.vtp_fieldsToSet.push({fieldName:"cookieDomain",value:e}),delete d.vtp_cookieDomain);return b})}();
Z.g.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:kn()}function b(f,h){ld(f,"hashchange",function(k){var l=a(k);h({source:"hashchange",state:null,url:mn(l),S:ln(l)})})}function c(f,h){ld(f,"popstate",function(k){var l=a(k);h({source:"popstate",state:k.state,url:mn(l),S:ln(l)})})}function d(f,h,k){var l=h.history,n=l[f];if(Ca(n))try{l[f]=function(q,p,r){n.apply(l,[].slice.call(arguments,0));k({source:f,state:q,url:mn(kn()),
S:ln(kn())})}}catch(q){}}function e(){var f={source:null,state:W("history").state||null,url:mn(kn()),S:ln(kn())};return function(h){var k=f,l={};l[k.source]=!0;l[h.source]=!0;if(!l.popstate||!l.hashchange||k.S!=h.S){var n={event:"gtm.historyChange","gtm.historyChangeSource":h.source,"gtm.oldUrlFragment":f.S,"gtm.newUrlFragment":h.S,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":h.state,"gtm.oldUrl":f.url,"gtm.newUrl":h.url};f=h;on(n)}}}(function(f){Z.__hl=f;Z.__hl.h="hl";Z.__hl.i=!0;Z.__hl.priorityOverride=
0})(function(f){var h=W("self");if(!tn("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);un("hl")}J(f.vtp_gtmOnSuccess)})}();Z.g.smm=["google"],function(){(function(a){Z.__smm=a;Z.__smm.h="smm";Z.__smm.i=!0;Z.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=co(a.vtp_map,"key","value")||{},d=c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue;wn(d,"smm",a.vtp_gtmEventId);return d})}();
...
Z.g.lcl=[],function(){function a(){var c=W("document"),d=0,e=function(f){var h=f.target;if(h&&3!==f.which&&!(f.eh||f.timeStamp&&f.timeStamp===d)){d=f.timeStamp;h=qd(h,["a","area"],100);if(!h)return f.returnValue;var k=f.defaultPrevented||!1===f.returnValue,l=Pl("lcl",k?"nv.mwt":"mwt",0),n;n=k?Pl("lcl","nv.ids",[]):Pl("lcl","ids",[]);if(n.length){var q=Ll(h,"gtm.linkClick",n);if(b(f,h,c)&&!k&&l&&h.href){var p=!!Ha(String(sd(h,"rel")||"").split(" "),function(t){return"noreferrer"===t.toLowerCase()});
p&&D(36);var r=W((sd(h,"target")||"_self").substring(1)),u=!0;if(on(q,Im(function(){var t;if(t=u&&r){var v;a:if(p){var x;try{x=new MouseEvent(f.type,{bubbles:!0})}catch(z){if(!c.createEvent){v=!1;break a}x=c.createEvent("MouseEvents");x.initEvent(f.type,!0,!0)}x.eh=!0;f.target.dispatchEvent(x);v=!0}else v=!1;t=!v}t&&(r.location.href=sd(h,"href"))}),l))u=!1;else return f.preventDefault&&f.preventDefault(),f.returnValue=!1}else on(q,function(){},l||2E3);return!0}}};ld(c,"click",e,!1);ld(c,"auxclick",
e,!1)}function b(c,d,e){if(2===c.which||c.ctrlKey||c.shiftKey||c.altKey||c.metaKey)return!1;var f=sd(d,"href"),h=f.indexOf("#"),k=sd(d,"target");if(k&&"_self"!==k&&"_parent"!==k&&"_top"!==k||0===h)return!1;if(0<h){var l=mn(f),n=mn(e.location);return l!==n}return!0}(function(c){Z.__lcl=c;Z.__lcl.h="lcl";Z.__lcl.i=!0;Z.__lcl.priorityOverride=0})(function(c){var d=void 0===c.vtp_waitForTags?!0:c.vtp_waitForTags,e=void 0===c.vtp_checkValidation?!0:c.vtp_checkValidation,f=Number(c.vtp_waitForTagsTimeout);
if(!f||0>=f)f=2E3;var h=c.vtp_uniqueTriggerId||"0";if(d){var k=function(n){return Math.max(f,n)};Ol("lcl","mwt",k,0);e||Ol("lcl","nv.mwt",k,0)}var l=function(n){n.push(h);return n};Ol("lcl","ids",l,[]);e||Ol("lcl","nv.ids",l,[]);tn("lcl")||(a(),un("lcl"));J(c.vtp_gtmOnSuccess)})}();
...
data:{scriptSource:ed,resume:function(){a()},containerProduct:"GTM"}};Ie.Df&&(q.data.initialPublish=!0);n.push(q)}else a()})(Pq);
