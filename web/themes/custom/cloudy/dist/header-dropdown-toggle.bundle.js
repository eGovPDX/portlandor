...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/header-dropdown-toggle.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./src/js/header-dropdown-toggle.js":
/*!******************************************!*\
  !*** ./src/js/header-dropdown-toggle.js ***!
  \******************************************/
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.cloudyHeaderMenuToggleOpenText = {
    attach: function attach(context, settings) {
      $(context).find(".cloudy-header__menu-wrapper").once("open-button-text").on("show.bs.collapse", function () {
  ...
  Drupal.behaviors.cloudyHeaderMenuToggleCloseText = {
    attach: function attach(context, settings) {
      $(context).find(".cloudy-header__menu-wrapper").once("close-button-text").on("hide.bs.collapse", function () {
  ...
  Drupal.behaviors.cloudyHeaderHideCurrentlyOpen = {
    attach: function attach(context, settings) {
      $(context).find(".collapse").once("hide-open").on("show.bs.collapse", function () {
        $(".collapse").each(function () {
          if ($(this).hasClass("show")) {
            $(this).toggleClass("no-transition").collapse("hide");
          }
...
/******/ });
//# sourceMappingURL=header-dropdown-toggle.bundle.js.map