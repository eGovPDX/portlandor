...
This module has been disconnected from the original GitHub repo and is being maintained on a custom basis
within the Portland.gov project. At some point in the future, we may decide to roll it as a submodule in
the portland module, or apply any customizations we might make as patches to the original project. There's
also the possibility it might eventually be rolled into an official release for Webform.
