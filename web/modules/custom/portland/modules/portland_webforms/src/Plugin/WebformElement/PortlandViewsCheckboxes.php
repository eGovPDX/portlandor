...
/**
 * Provides a 'portland_views_checkboxes' element.
 *
 * @WebformElement(
 *   id = "portland_views_checkboxes",
 *   label = @Translation("Portland Views Checkboxes"),
 *   description = @Translation("A checkboxes element populated from a View display."),
...
class PortlandViewsCheckboxes extends Checkboxes {
  ...
  public function prepare(array &$element, WebformSubmissionInterface $webform_submission = NULL) {
    // Temporarily treat this as a 'checkboxes' element so OptionsBase::prepare
    // applies wrapper-related behaviors (e.g. description display) correctly.
    $original_type = $element['#type'] ?? 'portland_views_checkboxes';
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['views_checkboxes'] = [
      '#type' => 'fieldset',
      '#title' => $this->t('Views checkboxes settings'),
      '#weight' => -40,
    ];

    $form['views_checkboxes']['view_id'] = [
      '#type' => 'select2',
      '#title' => t('View'),
    ...
    $form['views_checkboxes']['view_settings'] = [];
    $form['views_checkboxes']['view_settings']['display_id'] = [
      '#type' => 'select',
    ...
    $this->buildAjaxElement('views-checkboxes-view-settings', $form['views_checkboxes']['view_settings'], $form['views_checkboxes']['view_id']);

    $view_fields = self::getViewFields($element_properties['view_id'], $element_properties['display_id']);
    // create container for ajax trigger
    $form['views_checkboxes']['view_settings']['display_settings'] = [];
    $form['views_checkboxes']['view_settings']['display_settings']['label_field'] = [
      '#type' => 'select',
      '#title' => t('Label field'),
    ...
    $form['views_checkboxes']['view_settings']['display_settings']['value_field'] = [
      '#type' => 'select',
      '#title' => t('Value field'),
    ...
    $this->buildAjaxElement('views-checkboxes-display-settings', $form['views_checkboxes']['view_settings']['display_settings'], $form['views_checkboxes']['view_settings']['display_id']);

    $form['views_checkboxes']['cache_ttl_sec'] = [
      '#type' => 'number',
      '#min' => 0,
      '#step' => 1,
