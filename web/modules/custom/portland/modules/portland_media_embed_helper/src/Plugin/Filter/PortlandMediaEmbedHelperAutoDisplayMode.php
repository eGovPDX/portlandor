...
class PortlandMediaEmbedHelperAutoDisplayMode extends FilterBase {
  ...
  public function process($text, $langcode)
  {
    ...
    // data-align attribute will either be set to "right" or not included at all for full width

    // QUESTION: do we want to use the Embedded100 and Embedded50 display modes for videos as well?
