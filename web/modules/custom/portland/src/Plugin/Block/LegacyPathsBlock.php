...
class LegacyPathsBlock extends BlockBase {
    private static $help_text = "These are the URL aliases that redirect to this page. They include shortcut links, URLs from previous revisions, and legacy paths from the portlandoregon.gov migration.";
