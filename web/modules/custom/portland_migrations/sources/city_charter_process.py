...
charter[['id','article_id', 'number', 'title', 'TEXT', 'URL']].to_csv('city_charter_sections.csv', index=False)
...
chapters[['number', 'title', 'url', 'note']].to_csv('city_charter_chapters.csv', index=False)
...
articles[['id', 'chapter', 'number', 'title', 'url']].to_csv('city_charter_articles.csv', index=False)
