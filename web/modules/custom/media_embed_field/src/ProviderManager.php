...
class ProviderManager extends DefaultPluginManager implements ProviderManagerInterface, MapperInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/media_embed_field/Provider', $namespaces, $module_handler, 'Drupal\media_embed_field\ProviderPluginInterface', 'Drupal\media_embed_field\Annotation\MediaEmbedProvider');
    $this->alterInfo('media_embed_field_provider_info');
  }
