...
interface ProviderPluginInterface extends PluginInspectionInterface {
   ...
   * called unnecessarily, as it might query APIs for media thumbnail
   * information.
   *
   * @return string
  ...
  /**
   * Get the ID of the media from user input.
   *
   * @param string $input
   ...
   *
   * @return string
   *   A name to represent the media for the given plugin.
   */
