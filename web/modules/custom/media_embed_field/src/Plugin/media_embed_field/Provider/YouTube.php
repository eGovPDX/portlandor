...
namespace Drupal\media_embed_field\Plugin\media_embed_field\Provider;
...
class YouTube extends ProviderPluginBase {
  ...
  public function renderEmbedCode($width, $height, $autoplay) {
    $embed_code = [
      ...
      '#provider' => 'youtube',
      '#url' => sprintf('https://www.youtube.com/embed/%s', $this->getMediaId()),
      '#query' => [
        'autoplay' => $autoplay,
  ...
  public function getRemoteThumbnailUrl() {
    ...
    $high_resolution = sprintf($url, $this->getMediaId(), 'maxresdefault');
    $backup = sprintf($url, $this->getMediaId(), 'mqdefault');
    try {
