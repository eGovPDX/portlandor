...
namespace Drupal\Tests\media_embed_field\Unit;

use Drupal\Tests\UnitTestCase;
use Drupal\Tests\media_embed_field\Kernel\MockHttpClient;
use Drupal\media_embed_field\Plugin\media_embed_field\Provider\Vimeo;
use Drupal\media_embed_field\Plugin\media_embed_field\Provider\YouTube;
  ...
  public function urlsWithExpectedIds() {
    return [
      ...
      'YouTube: Standard URL' => [
        'Drupal\media_embed_field\Plugin\media_embed_field\Provider\YouTube',
      ...
      'YouTube Playlist' => [
        'Drupal\media_embed_field\Plugin\media_embed_field\Provider\YouTubePlaylist',
      ...
      // Vimeo passing cases.
      'Vimeo: Normal URL' => [
        'Drupal\media_embed_field\Plugin\media_embed_field\Provider\Vimeo',
