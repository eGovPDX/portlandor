...
/**
 * Test the Drupal 7 to 8 media_embed_field migration.
 *
...
class Drupal7MigrationTest extends MigrateDrupal7TestBase {
  ...
  public function testMigration() {
    ...
    $this->assertEquals('https://vimeo.com/21681203', $migrated_vimeo->field_media->value);
    $this->assertEquals('https://www.youtube.com/watch?v=XgYu7-DQjDQ', $migrated_youtube->field_media->value);
  }
