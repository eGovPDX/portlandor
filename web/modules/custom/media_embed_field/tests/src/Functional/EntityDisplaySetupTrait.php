...
trait EntityDisplaySetupTrait {
  ...
  /**
   * Create a media node using the media field.
   *
   * @param string $value
   *   The media URL to use for the field value.
   *
   * @return \Drupal\node\NodeInterface
   *   A node.
   */
  protected function createMediaNode($value) {
