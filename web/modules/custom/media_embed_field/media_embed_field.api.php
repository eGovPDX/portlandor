...
/**
 * @file
 * Hooks provided by media_embed_field.
 */

/**
 * Preprocess media iframes.
 *
 * For media providers that use the "media_embed_iframe" element, you can
 ...
 */
function hook_preprocess_media_embed_iframe(&$variables) {
...
/**
 * Preprocess iframes in the format of preprocess_media_embed_iframe__PROVIDER.
 *
 * Allows you to preprocess media embed iframes but only for specific providers.
 ...
 */
function hook_preprocess_media_embed_iframe__youtube(&$variables) {
  // Remove the YouTube logo from youtube embeds.
  $variables['query']['modestbranding'] = '1';
}

/**
 * Alter the media_embed_field plugin definitions.
 *
 ...
 */
function hook_media_embed_field_provider_info_alter(&$definitions) {
