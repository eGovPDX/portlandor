...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://pantheon:pantheon@database:3306/pantheon?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'http://portlandor.lndo.site//sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/app/web/sites/default/files/civicrm';
$civicrm_paths['civicrm.private']['path'] = '/app/web/sites/default/files/private/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://pantheon:pantheon@database:3306/pantheon?new_link=true');
  }
}
...
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/app/web/sites/default/files/private/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://portlandor.lndo.site');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '8m9YPFHntuVoxvGrS8ptikuzgwZh2o7kABbvxGnrLs');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:PwcpqdAz3YGstIMVSx2Eca3cRVfbz8YXCtdB5qkkvzNQ');
...
if (!defined('CIVICRM_DEPLOY_ID') ) {
  define( '_CIVICRM_DEPLOY_ID', 'DurzeaJhlWj3JA');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:mplEaQRvltlA40kBhVeGu4TXZ0szmrnS7aYwVlb7uwnmBA9raoFg');
...
// define( 'CIVICRM_MAIL_LOG', '/app/web/sites/default/files/private/civicrm/templates_c/mail.log');
// }
