...
7. Run `git checkout release` and `lando refresh` to build your local environment to match the release branch. (This runs composer install, drush updb, drush cim, and drush cr.)
